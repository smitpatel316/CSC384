...
def main():
    ...
    if test_min_moves:
        ...
        print("*************************************")
        print(
            "In the problem set provided, you calculated the correct Min Moves distance for {} states out of {}.".format(
                solved, len(PROBLEMS)
            )
        )
    ...
    if test_alternate:
        ...
        print(
            "Problems that remain unsolved in the set are Problems: {}".format(unsolved)
        )
        print(
            "Heur min moves alone solved {} out of {} practice problems given {} seconds.".format(
    ...
    if test_anytime_gbfs:
        ...
        for i in range(0, len(PROBLEMS)):
            ...
            if not final2 and not final1:
                print(
                    "Problem {}: not solveable with more time (no solution vs. no solution).".format(
                        i
                    )
                )
                unsolved.append(i)
                ...
                worsened += 1
                print(
                    "Problem {}: ERROR -- not solveable with more time ({} vs. no solution).".format(
                        i, final1.gval
                    )
                )
                ...
                solved += 1
                print(
                    "Problem {}: solveable with more time (no solution vs. {}).".format(
                        i, final2.gval
                    )
                )
                ...
                same += 1
                print(
                    "Problem {}: same with more time (length {} vs. {}).".format(
                        i, final1.gval, final2.gval
                    )
                )
            elif final2.gval < final1.gval:
                improved += 1
                print(
                    "Problem {}: improved with more time (length {} vs. {}).".format(
                        i, final1.gval, final2.gval
                    )
                )
            else:
                worsened += 1
                print(
                    "Problem {}: ERROR -- longer solution with more time (length {} vs. {}).".format(
                        i, final1.gval, final2.gval
                    )
                )
    ...
    if test_anytime_weighted_astar:
        ...
        for i in range(0, len(PROBLEMS)):
            ...
            s0 = PROBLEMS[i]  # Problems get harder as i gets bigger
            weight = 100
            final1 = anytime_weighted_astar(
                s0, heur_fn=heur_min_moves, weight=weight, timebound=timebound1
            )
            final2 = anytime_weighted_astar(
                s0, heur_fn=heur_min_moves, weight=weight, timebound=timebound2
            )
...
if __name__ == "__main__":
    ...
    #             break
    # problems = TESTPROBLEMS[20:40]
    # print(problems[0].board_properties)
    # problems[0].print_state()
    main()
    # se = SearchEngine("best_first", "full")
    # se.init_search(problems[0], goal_fn=rushhour_goal_fn, heur_fn=heur_alternate)
    # final = se.search(1)
    #
    # if final:
    #     print("got through")
